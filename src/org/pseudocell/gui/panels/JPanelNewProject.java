...
public class JPanelNewProject extends JPanel {
     ...
     * @param configNodeStimulation
     * @param nodeList
     */
    public JPanelNewProject(Config configurations, ConfigNodeStimulation configNodeStimulation, List<Node> nodeList) {
    ...
    private void setComponents() {
        ...
        JButton_Execute.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JButton_Execute_ActionPerformed(evt);
            }
        });
                ...
                JPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(JPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addGroup(JPanel2Layout.createSequentialGroup()
                                        .addContainerGap()
                                        .addComponent(listLogs, PREFERRED_SIZE, 491, PREFERRED_SIZE)
        ...
        JPanel2Layout.setVerticalGroup(
                JPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(JPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                .addGroup(JPanel2Layout.createSequentialGroup()
                                        .addGap(36, 36, 36)
                                        .addComponent(listLogs, PREFERRED_SIZE, 311, PREFERRED_SIZE)
    ...
    private void JButton_Execute_ActionPerformed(java.awt.event.ActionEvent evt) {
        // Checks if a name has been defined for the project
        if (JTextField_ProjectName.getText().isBlank()) {
        ...
        if (JTextField_ProjectName.getText().length() > fieldValidation.getMaxCharacterAllowed()) {
        ...
        listLogs.add(Config.dateFormat.format(new Date()) + "    Creating directory " + "results/" + JTextField_ProjectName.getText() + "/" + date + "/" + time);
