...
public class JPanelNetworkEditor extends JPanel {
    ...
    private JButton jButton_CreateBracket, jButton_CreateNew, jButton_Delete, jButton_Filter, jButton_Save;
    ...
    private JSpinnerDouble jSpinner_ConversionValue;
    ...
    private void setComponents() {
        ...
        jSpinner_ComparisionValue = new JSpinner();
    ...
    private void jButton_CreateNew_ActionPerformed(ActionEvent evt) {
        if (selectedNode != null) {
            CreateRule frame = new CreateRule(selectedNode, nodeList);
    ...
    private void jButton_Save_ActionPerformed() {
        JOptionPane.showMessageDialog(this, "[ERROR] Function not implemented.", "Function not implemented", JOptionPane.ERROR_MESSAGE);
    }
