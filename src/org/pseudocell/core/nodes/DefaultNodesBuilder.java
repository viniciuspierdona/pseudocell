...
public class DefaultNodesBuilder {
    ...
    public List<Node> createDefaultNodes() {
        ...
        AKT1.getRules().add(ruleFactory.createRule("(Node:RNF168# >= 1 | Node:mTORC2# >= 1 | "
                + "((Node:PI34P# >= 1 | Node:PI345P# >= 1) & Node:PDPK1# >= 1) | Node:ATM# >= 1 |"
        ...
        AMPK.getRules().add(ruleFactory.createRule("Node:ATM# >= 1 | Node:AMP# > 1", 1.0));
        ...
        ARAP1.getRules().add(ruleFactory.createRule("Node:SH3KBP1# >= 1 | Node:PI345P# >= 1", 1.0));
        ...
        ASAP1.getRules().add(ruleFactory.createRule("(Node:CRK# >= 1 | Node:SRC# >= 1 | Node:CBL# >= 1 | "
                + "Node:SH3KBP1# >= 1) & Node:PI45P# >= 1", 1.0));
        ...
        ATF2.getRules().add(ruleFactory.createRule("Node:p38# >= 1 | Node:JNK1# >= 1 | Node:JNK2# >= 1 | "
        ...
        ATP2B1.getRules().add(ruleFactory.createRule("(Node:CALM1# >= 1 | Node:CAPN1# >= 1) & (Node:PI45P# >= 1 | "
                + "Node:PKA# >= 1)", 2.0));
        ...
        ATP2B2.getRules().add(ruleFactory.createRule("(Node:CALM1# >= 1 | Node:CAPN1# >= 1) & Node:PI45P# >= 1", 2.0));
        ...
        ATP2B3.getRules().add(ruleFactory.createRule("(Node:CALM1# >= 1 | Node:CAPN1# >= 1) & Node:PI45P# >= 1", 2.0));
        ...
        ATP2B4.getRules().add(ruleFactory.createRule("((Node:CALM1# >= 1 | Node:CAPN1# >= 1) & Node:PI45P# >= 1) & "
        ...
        // Autophagosome
        Node Autophagosome = nodeFactory.createGeneralNode("Autophagosome");
        Autophagosome.getRules().add(ruleFactory.createRule("Node:BECN1# >= 1", 1.0));
        defaultNodes.add(Autophagosome);
        // Autophagy
        Node Autophagy = nodeFactory.createGeneralNode("Autophagy");
        Autophagy.getRules().add(ruleFactory.createRule("Node:Autophagosome# >= 1", 1.0));
        defaultNodes.add(Autophagy);
        // BAD
        ...
        BAX.getRules().add(ruleFactory.createRule("((Node:P53# >= 1 & Mod:P53#Ser46; == 1.0) | Node:tBID# >= 1 | "
                + "Node:BIM# >= 1) & Node:CtBP# == 0", 1.0));
        ...
        BCLXL.getRules().add(ruleFactory.createRule("(Node:P53# >= 1 | Node:BAD# >= 1 | Node:BIM# >= 1 | "
        ...
        BFL1.getRules().add(ruleFactory.createRule("Node:NFkB# >= 1", 1.0));
        ...
        CCL2.getRules().add(ruleFactory.createRule("Node:RELA# >= 1 | Node:NFkB# >= 1 | Node:JUN# >= 1", 1.0));
        ...
        CDKN1A.getRules().add(ruleFactory.createRule("Node:KAT5# >= 1 & (Node:RELB# >= 1 | Node:PRKCA# >= 1 | "
                + "(Node:P53# >= 1 & (Mod:P53#Lys120; == 1.0 | Mod:P53#Lys164; == 1.0 | Mod:P53#Lys305; == 1.0 | "
                + "Mod:P53#Ser46; == 1.0) & Mod:P53#Thr55; == 0.0)) & Node:MDM2# == 0", 1.0));
        ...
        CDKN2A.getRules().add(ruleFactory.createRule("Node:PSMC3# >= 1", 1.0));
        ...
        CXCL8.getRules().add(ruleFactory.createRule("(Node:JUN# >= 1 | Node:FOS# >= 1 | Node:RELA# >= 1 | "
                + "Node:p38# >= 1) & (Node:NKRF# == 0 | Node:RELA# >= 1) & Node:NuRDComplex# == 0 & "
        ...
        DRAM1.getRules().add(ruleFactory.createRule("Node:P53# >= 1", 1.0));
        ...
        DUSP1.getRules().add(ruleFactory.createRule("(Node:NFkB# >= 1 | Node:JUN# >= 1 | Node:ATF2# >= 1) & "
        ...
        ELK1.getRules().add(ruleFactory.createRule("Node:p38# >= 1 | Node:JNK1# >= 1 | Node:JNK2# >= 1 | "
                + "Node:JNK3# >= 1 | Node:ERK1# >= 1 | Node:ERK2# >= 1", 1.0));
        defaultNodes.add(ELK1);
        // ELK4
        Node ELK4 = nodeFactory.createNode("ELK4");
        ELK4.getRules().add(ruleFactory.createRule("Node:p38# >= 1 | Node:JNK1# >= 1 | Node:JNK2# >= 1 | "
                + "Node:JNK3# >= 1 | Node:ERK1# >= 1 | Node:ERK2# >= 1", 1.0));
        ...
        FAS.getRules().add(ruleFactory.createRule("(Node:P53# >= 1 | (Node:JUN# >= 1 & Node:FOS# == 0) & "
        ...
        // IAP2
        Node IAP2 = nodeFactory.createNode("IAP2");
        IAP2.getRules().add(ruleFactory.createRule("Node:NFkB# >= 1", 1.0));
        defaultNodes.add(IAP2);
        // ICAD
        ...
        // IKBKB
        Node IKBKB = nodeFactory.createNode("IKBKB");
        IKBKB.getRules().add(ruleFactory.createRule("Node:IKBKG# >= 1", 1.0));
        defaultNodes.add(IKBKB);
        // IKBKG
        ...
        IL6.getRules().add(ruleFactory.createRule("Node:p38# >= 1 & Node:KHSRP# == 0 & Node:ZFP36# == 0", 1.0));
        ...
        IP3R1.getRules().add(ruleFactory.createRule("Node:IP3# >= 1 & Node:Ca_c# < 3", 1.0));
        defaultNodes.add(IP3R1);
        // IP3R2
        Node IP3R2 = nodeFactory.createNode("IP3R2");
        IP3R2.getRules().add(ruleFactory.createRule("Node:IP3# >= 1 & Node:Ca_c# < 3", 1.0));
        defaultNodes.add(IP3R2);
        // IP3R3
        Node IP3R3 = nodeFactory.createNode("IP3R3");
        IP3R3.getRules().add(ruleFactory.createRule("Node:IP3# >= 1 & Node:Ca_c# < 3", 1.0));
        ...
        MAP2K1.getRules().add(ruleFactory.createRule("Node:RAF1# >= 1 | Node:MAP3K8# >= 1", 1.0));
        ...
        // MAP3K8
        Node MAP3K8 = nodeFactory.createNode("MAP3K8");
        MAP3K8.getRules().add(ruleFactory.createRule("Node:NFkB# >= 1", 1.0));
        defaultNodes.add(MAP3K8);
        // MAP4K3
        ...
        MAPKAPK2.getRules().add(ruleFactory.createRule("Node:p38# >= 1", 1.0));
        ...
        MDM2.getRules().add(ruleFactory.createRule("(Node:AKT1# >= 1 | Node:P53# >= 1 | Node:TAF1# >= 1) & "
        ...
        MRN.getRules().add(ruleFactory.createRule("Node:DSB# >= 1", 1.0));
        ...
        // NFkB
        Node NFkB = nodeFactory.createNode("NFkB");
        NFkB.getRules().add(ruleFactory.createRule("Node:AKT1# >= 1 | Node:CHUK# >= 1 | Node:IKBKB# >= 1", 1.0));
        defaultNodes.add(NFkB);
        // NHEJ
        ...
        NKRF.getRules().add(ruleFactory.createRule("Node:RELB# >= 1", 1.0));
        ...
        NOS2.getRules().add(ruleFactory.createRule("Node:NFkB# >= 1 | Node:RAC2# >= 1 | Node:NKRF# == 0", 1.0));
        ...
        NOXA.getRules().add(ruleFactory.createRule("Node:P53# >= 1 & Node:CtBP# == 0", 1.0));
        ...
        PIDD1.getRules().add(ruleFactory.createRule("Node:P53# >= 1", 1.0));
        ...
        PDPK1.getRules().add(ruleFactory.createRule("Node:PI34P# >= 1 | Node:PI345P# >= 1", 1.0));
        ...
        PLA2G4A.getRules().add(ruleFactory.createRule("Node:Ca_c# >= 1 | Node:ERK2# >= 1 | Node:p38# >= 1", 1.0));
        defaultNodes.add(PLA2G4A);
        // PLA2G4C
        Node PLA2G4C = nodeFactory.createNode("PLA2G4C");
        PLA2G4C.getRules().add(ruleFactory.createRule("Node:Ca_c# >= 1 | Node:ERK2# >= 1 | Node:p38# >= 1", 1.0));
        ...
        PPM1D.getRules().add(ruleFactory.createRule("Node:P53# >= 1", 1.0));
        ...
        PTEN.getRules().add(ruleFactory.createRule("Node:P53# >= 1", 1.0));
        ...
        PUMA.getRules().add(ruleFactory.createRule("((Node:P53# >= 1 & (Mod:P53#Lys120; == 1.0 | Mod:P53#Ser46; == 1.0)) & "
        ...
        // RELA
        Node RELA = nodeFactory.createNode("RELA");
        RELA.getRules().add(ruleFactory.createRule("Node:CHUK# >= 1 | Node:IKBKB# >= 1", 1.0));
        defaultNodes.add(RELA);
        // RELB
        Node RELB = nodeFactory.createNode("RELB");
        RELB.getRules().add(ruleFactory.createRule("Node:RELA# >= 1 | Node:NFkB# >= 1", 1.0));
        defaultNodes.add(RELB);
        // RHOA
        ...
        // RPS6KB1
        Node RPS6KB1 = nodeFactory.createNode("RPS6KB1");
        RPS6KB1.getRules().add(ruleFactory.createRule("Node:PDPK1# >= 1 | Node:mTORC1# >= 1", 1.0));
        defaultNodes.add(RPS6KB1);
        // RYR1
        ...
        TAB1.getRules().add(ruleFactory.createRule("Node:TRAF6# >= 1 & Node:p38# == 0", 1.0));
        ...
        TP53I3.getRules().add(ruleFactory.createRule("Node:P53# >= 1", 1.0));
        defaultNodes.add(TP53I3);
        // TP53INP1
        Node TP53INP1 = nodeFactory.createNode("TP53INP1");
        TP53INP1.getRules().add(ruleFactory.createRule("(Node:E2F1# >= 1 | Node:PRKCD# >= 1 | Node:P53# >= 1) & "
                + "(Node:Autophagosome# == 0 & Node:mir155# == 0)", 1.0));
        ...
        TSC2.getRules().add(ruleFactory.createRule("Node:AMPK# >= 1", 0.0));
        ...
        WASL.getRules().add(ruleFactory.createRule("Node:CDC42# >= 1 | Node:PI45P# >= 1", 1.0));
        ...
        mTORC1.getRules().add(ruleFactory.createRule("Node:AKT1# >= 1 | Node:TSC2# >= 1 | Node:AMPK# >= 1 | "
                + "Node:MAP4K3# >= 1", 1.0));
        ...
        // p300
        Node p300 = nodeFactory.createMiRNA("p300");
        defaultNodes.add(p300);
        // p38
        Node p38 = nodeFactory.createMiRNA("p38");
        p38.getRules().add(ruleFactory.createRule("(Node:MAP2K3# >= 1 | Node:MAP2K4# >= 1 | Node:MAP2K6# >= 1 | "
                + "Node:MAP2K7# >= 1 | Node:Superoxide# >= 2) & Node:PPM1D# == 0 & Node:DUSP1# == 0", 1.0));
        defaultNodes.add(p38);
        // P53
        Node P53 = nodeFactory.createP53();

        defaultNodes.add(P53);
        // sIL1R1
        ...
        // TAF1
        Node TAF1 = nodeFactory.createNode("TAF1");
        TAF1.getRules().add(ruleFactory.createRule("Node:AMP# <= 1 & Node:Apigenin# == 0", 1.0));
        defaultNodes.add(TAF1);
        // Apigenin
        ...
        TRAF2.getRules().add(ruleFactory.createRule("Node:TRADD# >= 1 | Node:TNFRSF1B# >= 1", 1.0));
        ...
        CYLD.getRules().add(ruleFactory.createRule("Node:NFkB# >= 1 & Node:CASP8# == 0", 1.0));
        ...
        // Telomere
        Node Telomere = nodeFactory.createGeneralNode("Telomere", 100.0);

        defaultNodes.add(Telomere);
        ...
        // IP3
        IP3.getRules().add(ruleFactory.createMetabolicRule("Node:PLCB2# >= 1", "PI45P", "IP3", 1.0));
        IP3.getRules().add(ruleFactory.createMetabolicRule("Node:PLCG1# >= 1", "PI45P", "IP3", 1.0));
        IP3.getRules().add(ruleFactory.createMetabolicRule("Node:PLCG2# >= 1", "PI45P", "IP3", 1.0));
        // NAD
        ...
        // PI345P             
        PI345P.getRules().add(ruleFactory.createMetabolicRule("Node:PI3K# >= 1", "PI45P", "PI345P", 1.0));
        // PI34P
        PI34P.getRules().add(ruleFactory.createMetabolicRule("Node:PI3K# >= 1", "PI3P", "PI34P", 1.0));
        PI34P.getRules().add(ruleFactory.createMetabolicRule("Node:INPP5D# >= 1", "PI345P", "PI34P", 1.0));
        PI34P.getRules().add(ruleFactory.createMetabolicRule("Node:INPPL1# >= 1", "PI345P", "PI34P", 1.0));
        // PI35P
        PI35P.getRules().add(ruleFactory.createMetabolicRule("Node:PIKFYVE# >= 1", "PI3P", "PI35P", 1.0));
        // PI3P
        PI3P.getRules().add(ruleFactory.createMetabolicRule("Node:PI3K# >= 1", "PtdIns", "PI3P", 1.0));
        PI3P.getRules().add(ruleFactory.createMetabolicRule("Node:INPP4B# >= 1", "PI34P", "PI3P", 1.0));
        PI3P.getRules().add(ruleFactory.createMetabolicRule("Node:FIG4# >= 1", "PI35P", "PI3P", 1.0));
        // PI45P
        PI45P.getRules().add(ruleFactory.createMetabolicRule("Node:PTEN# >= 1", "PI345P", "PI45P", 1.0));
        // PI5P
        PI5P.getRules().add(ruleFactory.createMetabolicRule("Node:PIKFYVE# >= 1", "PtdIns", "PI5P", 1.0));
        PI5P.getRules().add(ruleFactory.createMetabolicRule("Node:MTM1# >= 1", "PI35P", "PI5P", 1.0));
        PI5P.getRules().add(ruleFactory.createMetabolicRule("Node:MTMR2# >= 1", "PI35P", "PI5P", 1.0));
        PI5P.getRules().add(ruleFactory.createMetabolicRule("Node:MTMR3# >= 1", "PI35P", "PI5P", 1.0));
        // Peroxynitrite
        ...
        // PtdIns
        PtdIns.getRules().add(ruleFactory.createMetabolicRule("Node:MTM1# >= 1", "PI3P", "PtdIns", 1.0));
        PtdIns.getRules().add(ruleFactory.createMetabolicRule("Node:MTMR1# >= 1", "PI3P", "PtdIns", 1.0));
        PtdIns.getRules().add(ruleFactory.createMetabolicRule("Node:MTMR2# >= 1", "PI3P", "PtdIns", 1.0));
        PtdIns.getRules().add(ruleFactory.createMetabolicRule("Node:MTMR3# >= 1", "PI3P", "PtdIns", 1.0));
        PtdIns.getRules().add(ruleFactory.createMetabolicRule("Node:MTMR6# >= 1", "PI3P", "PtdIns", 1.0));
        // Ubiquinol
